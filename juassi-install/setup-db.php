...
if (!isset($_SESSION['pass']) || $_SESSION['pass'] < 4) {
	$juassi_page_title = 'Installing';
	include('includes/header.php');
	?>
	<div id="content">
		<div class="container">
			<div class="min-height">
				<p>Please start the install process from <a href="index.php">here</a>.</p>
			</div>
		</div>
	</div>
	<?php
...
$post_title = 'Juassi-Blog v.2.0';
$post_body = 'Bienvenidos a Juassi-Blog v.2.0.<br />Por favor lea el archivo readme.txt para la mayor&iacute;a de la informaci&oacute;n y ayuda.';
...
trigger_error('Juassi ' . juassi_get_config('program_version') . ' Instalado satisfactoriamente.', E_USER_NOTICE);
//session_destroy();

?>
<p>Juassi-Blog v.2.0 ha sido instalado satisfactoriamente.</p>
