...
class Invites {
	...
	public static function create_invite($user_id, $username, $location) {
		...
		$session->message("<div class='notification-box success-notification-box'><p>1 New invite code has been created.</p><a href='#' class='notification-close success-notification-close'>x</a></div><!--.notification-box .notification-box-success end-->");
	...
	public static function delete_invite($invite_code, $location) {
		...
		$database->query($sql);
		$session = new Session();
		$session->message("<div class='notification-box success-notification-box'><p>Invite code has been deleted successfully.</p><a href='#' class='notification-close success-notification-close'>x</a></div><!--.notification-box .notification-box-success end-->");
		redirect_to("$location");
	}
