<!-- final de main-content -->
</div>
<!-- final de contentwrapper -->
</div>
<!-- comienzo de sidebar -->
            <a href="javascript:void(0)" class="sidebar_switch on_switch ttip_r" title="Hide Sidebar" style="top:80px;">Sidebar switch</a>
            <div class="sidebar" >
						...
						<div class="antiscroll-content">
							...
							<div class="sidebar_inner">
								<form action="index.php?uid=1&amp;page=search_page" class="input-append" method="post" >
									<input autocomplete="off" name="query" class="search_query input-medium" size="16" type="text" placeholder="Buscar..." /><button type="submit" class="btn"><i class="icon-search"></i></button>
								</form>
									...
									<div class="accordion-group">
										<div class="accordion-heading">
											<a href="#collapseOne" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle">
												<i class="icon-folder-close"></i> Contenido
											</a>
										</div>
										<div class="accordion-body collapse" id="collapseOne">
											<div class="accordion-inner">
												<ul class="nav nav-list">
													<li><a href="javascript:void(0)">Art&iacute;culos</a></li>
													<li><a href="javascript:void(0)">Noticias</a></li>
													<li><a href="javascript:void(0)">Newsletters</a></li>
													<li><a href="javascript:void(0)">Comentarios</a></li>
												</ul>
											</div>
										</div>
									</div>
										...
										<div class="accordion-body collapse" id="collapseTwo">
											<div class="accordion-inner">
												<ul class="nav nav-list">
													...
													<li><a href="javascript:void(0)">Edici&oacute;n</a></li>
													<li><a href="javascript:void(0)">FAQ</a></li>
													<li><a href="javascript:void(0)">Creador de Form</a></li>
													<li><a href="javascript:void(0)">Localizaci&oacute;n</a></li>
									...
									<div class="accordion-group">
										<div class="accordion-heading">
											<a href="#collapseThree" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle">
												<i class="icon-user"></i> Administraci&oacute;n de cuentas
											</a>
										</div>
										<div class="accordion-body collapse" id="collapseThree">
											<div class="accordion-inner">
												<ul class="nav nav-list">
													...
													<li><a href="javascript:void(0)">Listas de correos</a></li>
									...
									<div class="accordion-group">
										<div class="accordion-heading">
											<a href="#collapseFour" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle">
												<i class="icon-cog"></i> Configuraci&oacute;n
											</a>
										</div>
										<div class="accordion-body collapse" id="collapseFour">
											<div class="accordion-inner">
												<ul class="nav nav-list">
													...
													<li class="active"><a href="javascript:void(0)">Configuraci&oacute;n de cuentas</a></li>
													<li><a href="javascript:void(0)">Bloqueo de IP's</a></li>
													<li class="nav-header">Sistema</li>
													<li><a href="javascript:void(0)">Informaci&oacute;n del sitio</a></li>
													<li><a href="javascript:void(0)">Acciones</a></li>
													<li><a href="javascript:void(0)">Cronolog&iacute;a</a></li>
													<li class="divider"></li>
									...
									<div class="accordion-group">
										<div class="accordion-heading">
											<a href="#collapseLong" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle">
												<i class="icon-leaf"></i> Contenidos largos (scrollbar)
											</a>
										</div>
								...
								Modificado por <a href="http://www.juassi.com">Juan C Reyes C</a>
							</form>
						</div>
					 </div>
				</div>
		...
		<div class="sidebar_info">
			<ul class="unstyled">
				<li>
					<span class="act act-warning"><?php echo juassi_total_comment_count(); ?></span>
					<strong>Comentarios</strong>
				</li>
				<li>
					<span class="act act-success"><?php echo juassi_total_post_count(); ?></span>
					<strong>Art&iacute;culos</strong>
				</li>
				<li>
					<span class="act act-danger"><?php echo juassi_total_mod_comment_count(); ?></span>
							<strong>Comentarios por Revisar</strong>
				</li>
             </ul>
        </div>
