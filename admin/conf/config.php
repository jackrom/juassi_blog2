 ...
 * 
 * Copyright (C) 2011-2012, the Juassi Analytics Team (see doc/authors.txt for details)
 *
...
// Syntax:
// $JUASSI_MAINSITE = "http://www.myserver.com/";    => Link to the specified URL
// $JUASSI_MAINSITE = ".."                           => Link to parent directory (Default)
// $JUASSI_MAINSITE = "";                            => Show no link
$JUASSI_MAINSITE = "..";

//  defaults to revealing the stats' settings. In case this behavior
// isn't desired you can deny access to it by deactivating the option.
// Syntax:
// $JUASSI_SHOW_CONFIG = 1;      => Display show_config.php
// $JUASSI_SHOW_CONFIG = "";     => Don't display show_config.php (Default)
$JUASSI_SHOW_CONFIG = "1";
...
$JUASSI_TITLEBAR = "Juassi Analytics";
...
$JUASSI_MAXBROWSER = 10;         // Browsers
$JUASSI_MAXEXTENSION = 10;       // Extensions
$JUASSI_MAXOS = 10;              // Operating Systems
$JUASSI_MAXROBOT = 10;           // Robots

$JUASSI_MAXHOST = 10;            // Hosts (reset possible)
$JUASSI_MAXKEY = 10;             // Keywords (reset possible)
$JUASSI_MAXORIGIN = 10;          // Referrers (reset possible)
$JUASSI_MAXPAGE = 10;            // Pages (reset possible)
...
$JUASSI_DETAILED_STAT_FIELDS = "id, time, ext, dns, visits, os, browser, referer";
...
$JUASSI_CUSTOM_CHARSET = "";

// BBClone CSS File Name
$JUASSI_CSS_FILE = "default.css";
