...
if (is_readable($JUASSI_LIB_PATH."html.php")) require_once($JUASSI_LIB_PATH."html.php");
else exit(juassi_msg($JUASSI_LIB_PATH."html.php"));

// Initialising the HTML class
$JUASSI_HTML = new JUASSI_HTML;

if (is_readable($JUASSI_LANGUAGE_PATH.$JUASSI_HTML->lng.".php")) require_once($JUASSI_LANGUAGE_PATH.$JUASSI_HTML->lng.".php");
// When no detection, use English language as default
elseif (is_readable($JUASSI_LANGUAGE_PATH."en.php")) {
}
else exit(juassi_msg($JUASSI_LANGUAGE_PATH."en.php"));
